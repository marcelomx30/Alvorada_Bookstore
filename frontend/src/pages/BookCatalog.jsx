      ...
      <nav className="bg-white shadow-md">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={logout}
              className="px-4 py-2 bg-alvorada-coral text-white rounded-lg hover:bg-alvorada-coral-dark transition-colors font-semibold"
            >
              Sair
            </button>
          </div>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <p className="text-gray-600 text-sm">
                        <span className="font-semibold">Cópias disponíveis:</span> {book.numero_copias}
                      </p>
                    </div>
